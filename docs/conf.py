# -*- coding: utf-8 -*-
#
# GravitySpy documentation build configuration file, created by
...
from gwcosmology import __version__ as gwcosmology_version
...
version = gwcosmology_version
# The full version, including alpha/beta/rc tags.
release = gwcosmology_version
...
htmlhelp_basename = 'GravitySpydoc'
...
man_pages = [
    (master_doc, 'gwcosmology', u'GravitySpy Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'GravitySpy', u'GravitySpy Documentation',
     author, 'GravitySpy', 'One line description of project.',
     'Miscellaneous'),
]
